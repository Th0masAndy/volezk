...
impl std::ops::Div for Mersenne61Ext {
    type Output = Self;
...
impl core::iter::Sum for Mersenne61Ext {
    fn sum<I: Iterator<Item = Self>>(iter: I) -> Self {
        iter.fold(Mersenne61Ext::ZERO, |a, b| a + b)
    }
}

impl<'a> core::iter::Sum<&'a Mersenne61Ext> for Mersenne61Ext {
    fn sum<I: Iterator<Item = &'a Mersenne61Ext>>(iter: I) -> Self {
        iter.fold(Mersenne61Ext::ZERO, |a, b| a + *b)
    }
}
...
impl MyField for Mersenne61Ext {
    ...
    const ONE: Mersenne61Ext = Mersenne61Ext { real: 1, image: 0 };
    const ZERO: Mersenne61Ext = Mersenne61Ext { real: 0, image: 0 };
    #[inline(always)]
    ...
    #[inline]
    fn from_hash(hash: [u8; crate::utils::merkle_tree::MERKLE_ROOT_SIZE]) -> Self {
        Mersenne61Ext {
            real: (0..7)
                .into_iter()
